                    ...
                    <TableBody>
                        {users.map((user) => (
                            <TableRow key={user.id}>
                                ...
                                <TableCell className="text-center">{user.permissions.map((item,index) => <Badge variant="outline" key={index} className="text-right">{formatString(item)}</Badge>)}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                    <TableFooter>
